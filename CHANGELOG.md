...
### Dependencies
- Bump opentelemetry.version from 1.19.0 to 1.21.0
- Bump opentelemetry-semconv.version from 1.19.0-alpha to 1.21.0-alpha
...
- Bump pitest-maven from 1.9.7 to 1.10.3
...
- Bump protobuf-java from 3.21.7 to 3.21.11
...
- Bump modelmapper from 3.1.0 to 3.1.1
